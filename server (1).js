...
// POST /api/login { nickname, password } -> { success, atoms, antiModda, isAdmin, unlockedFiles }
...
app.post('/api/recover-password', (req, res) => {
  ...
  saveDB(db);
  res.json({ success: true, atoms: db[found.userId].atoms, antiModda: db[found.userId].antiModda, isAdmin: !!db[found.userId].isAdmin, unlockedFiles: db[found.userId].unlockedFiles || [] });
});
